...
CREATE TABLE customers ( cnum number(4), 
cname varchar2(10),
city varchar2(10), 
snum number(4) );
...
CREATE TABLE orders ( onum number(4),
amt number(7), 
odate date, 
cnum number(4), 
snum number(4) );
...
--   SELECT Count(*),snum,sname,city,comm FROM salespeople WHERE city is 'Newyork' ;with details
